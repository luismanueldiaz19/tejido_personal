...
class CardSublimacionHistorial extends StatefulWidget {
  const CardSublimacionHistorial({
    Key? key,
  ...
  @override
  State<CardSublimacionHistorial> createState() =>
      _CardSublimacionHistorialState();
}

class _CardSublimacionHistorialState extends State<CardSublimacionHistorial> {
  ////////////Multi Imagen/////
  List<File> listFile = [];
  ...
  String urlImage =
      "http://$ipLocal/tejidos/admin/image_sublimacion_department/";
  ////////////////////////
  ...
  Future sendMulpleImage(List listBase64Imagen) async {
    ...
    for (int i = 0; i < listBase64Imagen.length; i++) {
      await httpRequestDatabase(uploadImagenSublimacion, {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Trabajo Id : ${widget.current.idKeyWork.toString()}",
                            style:
                          ...
                          Row(
                            children: [
                              Text(
                                'Pcs ${widget.current.cantPieza.toString()}',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall!
                                    .copyWith(fontSize: textSize),
                              ...
                              Text(
                                'Orden : ${widget.current.cantOrden.toString()}',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall!
                                    .copyWith(
