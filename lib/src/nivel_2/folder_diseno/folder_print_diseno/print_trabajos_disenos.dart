    ...
    pdf.addPage(
      MultiPage(
        build: (context) => [
          ...
          buildHeader(image, 'Informacion Trabajos Diseños'),
...
// {"id":"4","ficha":"N\/A","num_orden":"N\/A",
//"cantidad":"23","comment":"NADA",
//"type_worked":"CUERPO COMPLETO DISE\u00d1O NUEVO",
//"date_start":"2023-07-02 13:44:11",
//"date_end":"2023-07-02 13:44:23","user_registered":"LUDEVELOPER"}
//////////////table de la lista de tipo de tabajopor nombre de usuarios////////
  static Widget buildTable(List<AtencionCliente> tableData) {
    ...
    return Table.fromTextArray(
      ...
      cellStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: 7),
